    ...
    <div className='page'>
      ...
      <section className='col-2'>
        <div>
          ...
          <p>Hos Levels finder man et hav af værktøjer indenfor en række forskellige områder. Vi kan hjælpe med alt fra visuel idenditet til hybride apps. </p>
          <p>Om du er helt grøn og nystartet og skal bruge en simpel hjemmeside eller om I er en større virksomhed der ønsker at få strømlinnet jeres nyværende kodebase eller noget helt tredje, så er Levels jeres rette samarbejdspartner.</p>
